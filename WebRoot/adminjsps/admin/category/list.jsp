    ...
    <c:forEach items="${parents }" var="parent">	
    	<tr class="trOneLevel">
    		...
    		<td width="200px;">
    		  ...
    		  <a onclick="return confirm('您是否真要删除该一级分类？')" href="/admin/AdminCategoryServlet?method=deleteParent&cid=${parent.cid }">删除</a>
    		</td>
    	</tr>
    	<c:forEach items="${parent.children }" var="child">
	    	<tr class="trTwoLevel">
	    		...
	    		<td width="200px;" align="right">
	    		  ...
	    		  <a onclick="return confirm('您是否真要删除该二级分类？')" href="/admin/AdminCategoryServlet?method=deleteChild&cid=${child.cid }">删除</a>
	    		</td>
	    	</tr>
	    </c:forEach>	
     </c:forEach>
